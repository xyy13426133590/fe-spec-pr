...
describe('Validate TS configs', () => {
  it('Validate xyy-eslint-config/typescript', async () => {
  ...
  it('Validate xyy-eslint-config/typescript/vue', async () => {
  ...
  it('Validate xyy-eslint-config/essential/typescript', async () => {
  ...
  it('Validate xyy-eslint-config/essential/typescript/react', async () => {
  ...
  it('Validate xyy-eslint-config/essential/typescript/vue', async () => {
  ...
  it('Validate xyy-eslint-config/typescript/node', async () => {
