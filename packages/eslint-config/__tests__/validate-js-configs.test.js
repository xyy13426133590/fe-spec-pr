...
describe('Validate JS configs', () => {
  it('Validate xyy-eslint-config', async () => {
  ...
  it('Validate xyy-eslint-config/es5', async () => {
  ...
  it('Validate xyy-eslint-config/vue', async () => {
  ...
  it('Validate xyy-eslint-config/essential', async () => {
  ...
  it('Validate xyy-eslint-config/essential/es5', async () => {
  ...
  it('Validate xyy-eslint-config/essential/react', async () => {
  ...
  it('Validate xyy-eslint-config/essential/vue', async () => {
  ...
  it('Validate xyy-eslint-config/node', async () => {
